...
// namespace ProjectOrigin.Registry.Server.Tests;
...
//     private IOptions<TransactionProcessorOptions> CreateOptions(string registryName)
//     {
//         return CreateOptionsMock<TransactionProcessorOptions>(new TransactionProcessorOptions { RegistryName = registryName });
//     }
